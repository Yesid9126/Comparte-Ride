    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Circle admins can update the circles data and manage its members', verbose_name='circle admin')),
                ...
                ('is_activate', models.BooleanField(default=True, help_text='only active users are allowed to interactive in the circle', verbose_name='active status')),
